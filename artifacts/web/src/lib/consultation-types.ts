...
export const CONSULTATION_TYPES: ConsultationType[] = [
  ...
  {
    id: "medicina-geral",
    labelPt: "Consulta em Clínica",
    labelEn: "Clinic Consultation",
    labelEs: "Consulta en Clínica",
    labelFr: "Consultation en Clinique",
    labelDe: "Praxisberatung",
    durationMinutes: 30,
    startHour: 14,
    endHour: 20,
    icon: Stethoscope,
  ...
  {
    id: "domicilio",
    labelPt: "Consulta ao Domicílio",
    labelEn: "Home Visit",
    labelEs: "Consulta a Domicilio",
  ...
  {
    id: "atestado",
    labelPt: "Emissão de Atestado Médico",
